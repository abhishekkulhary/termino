...
int get hashCode {
  final _this = this as TerminalSettings;
  return Object.hash(runtimeType,_this.paletteId,_this.themeMode,_this.fontSize,_this.lineHeight,_this.fontFamily,_this.cursorShape,_this.cursorBlinks,_this.bell,_this.scrollbackLines,_this.relayUrl,_this.onboardingComplete);
}
...
@useResult
$Res call({
 String? paletteId, AppThemeMode themeMode, double fontSize, double lineHeight, String? fontFamily, TerminalCursorShape cursorShape, bool cursorBlinks, BellBehaviour bell, int scrollbackLines, String? relayUrl, bool onboardingComplete
});
...
switch (_that) {
case _TerminalSettings() when $default != null:
return $default(_that.paletteId,_that.themeMode,_that.fontSize,_that.lineHeight,_that.fontFamily,_that.cursorShape,_that.cursorBlinks,_that.bell,_that.scrollbackLines,_that.relayUrl,_that.onboardingComplete);case _:
  return orElse();
...
@override
int get hashCode {
    return Object.hash(runtimeType,paletteId,themeMode,fontSize,lineHeight,fontFamily,cursorShape,cursorBlinks,bell,scrollbackLines,relayUrl,onboardingComplete);
}

@override
String toString() {
    return 'TerminalSettings(paletteId: $paletteId, themeMode: $themeMode, fontSize: $fontSize, lineHeight: $lineHeight, fontFamily: $fontFamily, cursorShape: $cursorShape, cursorBlinks: $cursorBlinks, bell: $bell, scrollbackLines: $scrollbackLines, relayUrl: $relayUrl, onboardingComplete: $onboardingComplete)';
}
