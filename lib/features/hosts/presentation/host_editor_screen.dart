        ...
        child: ListView(
          ...
          children: [
            ...
            DropdownButtonFormField<String?>(
              ...
              items: [
                ...
                for (final identity in identities)
                  DropdownMenuItem(
                    value: identity.id,
                    child: Text('${identity.name} (${identity.keyType.label})'),
                  ),
              ],
            ...
            DropdownButtonFormField<String?>(
              ...
              decoration: const InputDecoration(
                labelText: 'Jump host',
                helperText: 'Tunnel through another saved host (ProxyJump)',
              ),
              items: [
                const DropdownMenuItem(child: Text('Direct')),
                for (final other in others)
                  DropdownMenuItem(value: other.id, child: Text(other.label)),
              ],
